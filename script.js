...
id1.addEventListener("click", () => toggleIcon(id1));
id2.addEventListener("click", () => toggleIcon(id2));
id3.addEventListener("click", () => toggleIcon(id3));
id4.addEventListener("click", () => toggleIcon(id4));
...
function toggleIcon(button) {
    ...
    if (button.innerHTML === plusElement.innerHTML) {
